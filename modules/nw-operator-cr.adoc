...
|`array`
|This setting enables a dynamic routing provider. The FRR routing capability provider is required for additional route advertisement. The only supported value is `FRR`.
